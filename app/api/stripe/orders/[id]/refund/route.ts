...
import { refundOrder } from "@/lib/stripe/orders"
import { refundOrderSchema } from "@/lib/validation/order.schema"
...
export async function POST(req: Request, { params }: Ctx) {
  ...
  try {
    const refund = await refundOrder(id, { amount: parsed.data.amount })
