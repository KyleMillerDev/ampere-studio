...
import { cancelOrder } from "@/lib/stripe/orders"
import { cancelOrderSchema } from "@/lib/validation/order.schema"
...
export async function POST(req: Request, { params }: Ctx) {
  ...
  try {
    const order = await cancelOrder(id, { refund: parsed.data.refund })
